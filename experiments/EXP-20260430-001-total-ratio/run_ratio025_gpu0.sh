...
KEEP_RATIO="0.25"
MODEL_ARGS="pretrained=/workspace/zap/ckpts/llava-onevision-qwen2-7b-ov-hf,student_path=/workspace/zap/ckpts/student_onevision_A_ep20,keep_ratio=${KEEP_RATIO},device=cuda:0"
OUT_DIR="/workspace/VFlowOpt/experiments/EXP-20260430-001-total-ratio/outputs/student_ep20/keep025"
...
echo "===== ALL DONE gpu0 ratio=${KEEP_RATIO} $(date -Is) ====="
